package de.finnp.movinghologram.v1_8_R3.hologram;

import de.finnp.movinghologram.v1_8_R3.MovingHologramPlugin;
...
public class ItemHologram extends Hologram {
    ...
    @NonNull
    private final net.minecraft.server.v1_8_R3.ItemStack itemStack;
    @NonNull
    ...
    private void sendItem(@NonNull final net.minecraft.server.v1_8_R3.ItemStack itemStack) {
