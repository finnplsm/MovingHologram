package de.finnp.movinghologram.v1_18_R2.hologram;

import de.finnp.movinghologram.v1_18_R2.MovingHologramPlugin;
...
public class TextHologram extends Hologram {
    ...
    public TextHologram(@NonNull final Location location, @NonNull final Player player, @NonNull final String rawLine) {
        ...
        this.armorStand.a(IChatBaseComponent.ChatSerializer.a(" "));
    ...
    private void setText(@NonNull final String text) {
        this.armorStand.a(IChatBaseComponent.ChatSerializer.a(text));
