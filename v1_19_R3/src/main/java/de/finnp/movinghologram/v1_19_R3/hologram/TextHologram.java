package de.finnp.movinghologram.v1_19_R3.hologram;

import de.finnp.movinghologram.v1_19_R3.MovingHologramPlugin;
...
public class TextHologram extends Hologram {
    ...
    private void updateMetadata() {
        @NonNull final DataWatcher dataWatcher = this.armorStand.aj();
