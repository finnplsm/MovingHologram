package de.finnp.movinghologram.v1_17_R1.hologram;

import com.mojang.datafixers.util.Pair;
import de.finnp.movinghologram.v1_17_R1.MovingHologramPlugin;
...
public class ItemHologram extends Hologram {
    ...
    @NonNull
    private final static net.minecraft.world.item.ItemStack ITEM_STACK_AIR = CraftItemStack.asNMSCopy(new ItemStack(Material.AIR));
    @NonNull
