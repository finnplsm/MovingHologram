package de.finnp.movinghologram.v1_13_R2.hologram;

import de.finnp.movinghologram.v1_13_R2.MovingHologramPlugin;
...
public class ItemHologram extends Hologram {
    ...
    @NonNull
    private final net.minecraft.server.v1_13_R2.ItemStack itemStack;
    @NonNull
    ...
    private void sendItem(@NonNull final net.minecraft.server.v1_13_R2.ItemStack itemStack) {
