package de.finnp.movinghologram.v1_15_R1.hologram;

import de.finnp.movinghologram.v1_15_R1.MovingHologramPlugin;
...
public class ItemHologram extends Hologram {
    ...
    private void sendItem(@NonNull final net.minecraft.server.v1_15_R1.ItemStack itemStack) {
