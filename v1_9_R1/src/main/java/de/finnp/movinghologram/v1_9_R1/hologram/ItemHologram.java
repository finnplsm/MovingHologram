...
import de.finnp.movinghologram.v1_9_R1.MovingHologramPlugin;
...
public class ItemHologram extends Hologram {
    ...
    @NonNull
    private final net.minecraft.server.v1_9_R1.ItemStack itemStack;
    @NonNull
    ...
    private void sendItem(@NonNull final net.minecraft.server.v1_9_R1.ItemStack itemStack) {
