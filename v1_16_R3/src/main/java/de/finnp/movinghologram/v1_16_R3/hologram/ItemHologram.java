package de.finnp.movinghologram.v1_16_R3.hologram;

import com.mojang.datafixers.util.Pair;
import de.finnp.movinghologram.v1_16_R3.MovingHologramPlugin;
...
public class ItemHologram extends Hologram {
    ...
    @NonNull
    private final static net.minecraft.server.v1_16_R3.ItemStack ITEM_STACK_AIR = CraftItemStack.asNMSCopy(new ItemStack(Material.AIR));
    @NonNull
    ...
    private void sendItem(@NonNull final net.minecraft.server.v1_16_R3.ItemStack itemStack) {
        @NonNull final List<Pair<EnumItemSlot, net.minecraft.server.v1_16_R3.ItemStack>> list = Arrays.asList(
